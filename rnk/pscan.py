"""
Parallel Scan (PScan) implementation for Mamba SSM.

Pure PyTorch implementation from https://github.com/alxndrTL/mamba.py
...
class PScan(torch.autograd.Function):
    ...
    def forward(ctx, A_in, X_in):
        """Apply parallel scan. Returns new tensor."""
        L = X_in.size(1)
